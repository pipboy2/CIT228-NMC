...
<ul>";
    ...
    $display_block .= "<br/>
<p style=\"text‐align: center\"><a href=\"addEntry.php?masterid=".$_POST['sel_id']."\">add address</a><br><br>
   <a href=\"".$_SERVER['PHP_SELF']."\">select address</a> <br><br>  <a href='menu.html'>main menu</a>
</p>";
}
mysqli_close($mysqli);
?>
