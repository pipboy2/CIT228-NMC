...
FROM mastername ORDER BY lname, fname";
    ...
    if (mysqli_num_rows($get_list_res) < 1) {
        $display_block .= "<p><em>No records to select!</em><br><br>
...
<button type=\"submit\" name=\"submit\" value=\"del\">Delete Selected Entry</button><br><br>
<a href='menu.html'>Main Menu</a>
    ...
    mysqli_close($mysqli);
    $display_block = "<h1>Record(s) Deleted</h1><p>Entry Deleted<br><br>
<a href=\"".$_SERVER['PHP_SELF']."\">delete another</a> <br><br><a href='menu.html'>
main menu</a></p>";
}
?>
<head>
    <title>Delete Address Entry</title>
