...
if (!$_POST)  {
	...
	if (mysqli_num_rows($get_list_res) < 1) {
		//no records
		$display_block .= "<p><em>Sorry, no records to select!</em><br><br>
		...
		<button type=\"submit\" name=\"submit\" value=\"change\">Change Selected Entry</button><br>
		<a href='menu.html';><br><br>
	Main Menu</a></p>
		</form>";
	}
	//free result
...
END_OF_BLOCK;
	...
	$display_block .= "<p><button type='submit' name='submitChange' id='submitChange' value='submitChange'>Update Entry</button>";
	$display_block .= "<a href='menu.html';><br><br>
	Main Menu</a></p>";
}
